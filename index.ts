          ...
          uploadPromises.push((async () => {
            ...
            if (enable_visual_diffs && LINK_FILE_REGEX.test(local_relative_path)) {
              ...
              try {
                ...
                core.warning(`Could not parse link file ${local_relative_path} to determine source path for untracked logic: ${(parseError as Error).message}`);
              }
            ...
            try {
              ...
              core.error(`Failed processing outgoing file ${local_relative_path}: ${(uploadError as Error).message}`);
