        ...
        try {
            ...
            if (trigger_event_name === 'push') {
                ...
                try {
                    ...
                    core.error(`Failed list Drive content before outgoing sync: ${listError.message}. Skipping outgoing sync steps.`);
                ...
                try {
                    ...
                    core.error(`Failed re-list Drive content after outgoing sync: ${listError.message}. Skipping untracked handling.`);
                    operation_failed = true;
                    core.endGroup(); // Close group before continuing
