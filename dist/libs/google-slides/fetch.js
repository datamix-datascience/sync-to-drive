...
import { google } from "googleapis"; // Import slides_v1
 ...
 */
export async function fetch_google_slide_json(authClient, // Use the specific JWT type
presentation_id) {
    ...
    try {
        ...
        const err = error; // Cast to access potential properties
        ...
        if (err.code)
            core.error(`   - Error Code: ${err.code}`);
        return null;
    }
}
