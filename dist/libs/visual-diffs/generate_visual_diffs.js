...
export async function generate_visual_diffs_for_pr(params) {
    ...
    try {
        ...
        await summarizePRChanges(params.octokit, params.owner, params.repo, params.pr_number);
    }
    catch (error) {
    ...
    if (temp_dir) {
        ...
        await fs.promises
            ...
            .catch((rmErr) => core.warning(`Failed to remove base temp directory ${temp_dir}: ${rmErr.message}`));
    }
